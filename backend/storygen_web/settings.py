"""
Django settings for storygen_web project.
...
SECRET_KEY = 'django-insecure-f^cr#vt6%%_h)9nidagjar6yn3k5$)0g+kco(2*6(l5+!s)e-%'
...
WSGI_APPLICATION = 'storygen_web.wsgi.application'
